...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      <section class="content-header">
          <h1>
              File
              <small>Download panel</small>
          </h1>
          <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Download Panel</li>
          </ol>
      </section>
            ...
            <div class="col-md-6">
              <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                          <li class="active"><a href="#semister1" data-toggle="tab">Semister 1</a></li>
                          <li><a href="#semister2" data-toggle="tab">Semister 2</a></li>
                      </ul>
                      <div class="tab-content">
                          <div class="tab-pane active" id="semister1">
                              
                          </div>

                          <div class="tab-pane" id="semister2">
              ...
              <div class="col-md-6">
                  <div class="nav-tabs-custom">
                      <ul class="nav nav-tabs">
                          <li class="active"><a href="#semister3" data-toggle="tab">Semister 1</a></li>
                          <li><a href="#semister4" data-toggle="tab">Semister 2</a></li>
                      </ul>
                      <div class="tab-content">
                          <div class="tab-pane active" id="semister3">

                          </div>

                          <div class="tab-pane" id="semister4">
...
<!--            <div class="row">
                <div class="col-xs-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class=""><a href="#semister3" data-toggle="tab">Semister 1</a></li>
                            <li><a href="#semister4" data-toggle="tab">Semister 2</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="semister3">
