    ...
    <script src="bower_components/customized_js/jssor.slider-27.1.0.min.js" type="text/javascript"></script>
...
<div id="jssor_1" style="position:relative;top:0px;width:1200px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1200px;height:380px;overflow:hidden;">
            <div data-p="170.00">
                <img data-u="image" src="database/advatisiment_data/jamirax980.png" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="database/advatisiment_data/jamirax96.png" />
                    <span class="ti"><?php echo $Translation['companyName']; ?></span><br />
                    <!--<span class="d">Notices</span>-->
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="database/advatisiment_data/deesynertzx980.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="database/advatisiment_data/deesynertzx96.jpg" />
                    <span class="ti"><?php echo $Translation['companyName']; ?></span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="database/advatisiment_data/lotionx980.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="database/advatisiment_data/lotionx96.jpg" />
                    <span class="ti"><?php echo $Translation['companyName']; ?></span><br />
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="database/advatisiment_data/extrax980.jpg" />
                <div data-u="thumb">
                    <img data-u="thumb" class="i" src="database/advatisiment_data/extrax96.jpg" />
                    <span class="ti"><?php echo $Translation['companyName']; ?></span><br />
                </div>
            </div>
        </div>
